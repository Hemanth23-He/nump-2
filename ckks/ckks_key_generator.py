...
class CKKSKeyGenerator:
    ...
    def generate_public_key(self, params):
        ...
        # Compute p0 = -a*s + e (mod big_modulus)
    ...
    def generate_switching_key(self, new_key):
        ...
        # Sample random polynomial and error for switching key
        ...
        # Compute sw0 = -a*s + e + P*new_key (mod P^2)
    ...
    def generate_relin_key(self, params):
        ...
        Args:
            params (Parameters): Parameters including polynomial degree,
                plaintext, and ciphertext modulus.
        """
        # Compute s^2 for relinearization
    ...
    def generate_rot_key(self, rotation):
        ...
        Returns:
            A rotation key.
        """
        # Generate K_5^r(s) - switching key for rotated secret key
    ...
    def generate_conj_key(self):
        ...
        Returns:
            A conjugation key.
        """
        # Generate K_{-1}(s) - switching key for conjugated secret key
