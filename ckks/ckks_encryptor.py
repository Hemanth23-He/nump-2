...
class CKKSEncryptor:
    ...
    def encrypt_with_secret_key(self, plain):
        ...
        # Generate random polynomial and error using triangle distribution
        ...
        # Compute c0 = sk * random_vec + error + plaintext (mod coeff_modulus)
        ...
        # Compute c1 = -random_vec (mod coeff_modulus)
    ...
    def encrypt(self, plain):
        ...
        # Generate random polynomial and errors using triangle distribution
        random_vec = Polynomial(self.poly_degree, sample_triangle(self.poly_degree))
        ...
        # Compute c0 = p0 * random_vec + error1 + plaintext (mod coeff_modulus)
        c0 = p0.multiply(random_vec, self.coeff_modulus, crt=self.crt_context)
        c0 = error1.add(c0, self.coeff_modulus)
        c0 = c0.add(plain.poly, self.coeff_modulus)
        c0 = c0.mod_small(self.coeff_modulus)
        
        # Compute c1 = p1 * random_vec + error2 (mod coeff_modulus)
